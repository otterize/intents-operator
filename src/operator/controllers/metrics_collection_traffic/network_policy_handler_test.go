...
func (s *NetworkPolicyHandlerTestSuite) SetupTest() {
	...
	s.handler = NewNetworkPolicyHandler(s.Client, &runtime.Scheme{}, allow_metrics_collection_traffic.IfBlockedByOtterize)
...
func (s *NetworkPolicyHandlerTestSuite) TestNetworkPolicyHandler_HandleAlways_ShouldAddPolicy() {
	s.setHandler(allow_metrics_collection_traffic.Always)
	s.mockForReturningScrapePodInListNamespace()
	s.mockForResolvingScrapingPodIdentity()
...
func (s *NetworkPolicyHandlerTestSuite) TestNetworkPolicyHandler_HandleOff_ShouldDoNothing() {
	s.setHandler(allow_metrics_collection_traffic.Off)
	s.mockForReturningScrapePodInListNamespace()
	s.mockForResolvingScrapingPodIdentity()
...
func (s *NetworkPolicyHandlerTestSuite) setHandler(allowMetricsCollector allow_metrics_collection_traffic.Enum) {
