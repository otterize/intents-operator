...
type NetworkPolicyHandler struct {
	...
	allowMetricsCollector allow_metrics_collection_traffic.Enum
}
...
func (r *NetworkPolicyHandler) buildNetworkPolicyIfNeeded(ctx context.Context, pod *PotentiallyScrapeMetricPod) (v1.NetworkPolicy, bool, error) {
	...
	if r.allowMetricsCollector == allow_metrics_collection_traffic.Always {
	...
	if r.allowMetricsCollector == allow_metrics_collection_traffic.Off {
		return v1.NetworkPolicy{}, false, nil
	}
