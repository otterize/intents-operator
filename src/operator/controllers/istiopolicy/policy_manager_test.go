...
func (s *PolicyManagerTestSuite) TestCreateProtectedService() {
	...
	intents := &v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
			Name:      policyName,
			Namespace: clientIntentsNamespace,
			Labels: map[string]string{
				v2.OtterizeServiceLabelKey:             "test-server-test-namespace-8ddecb",
				v2.OtterizeIstioClientWithKindLabelKey: "test-client-test-namespace-537e87",
			},
		},
		Spec: &v2.IntentsSpec{
			...
			Targets: []v2.Target{
				{
					Kubernetes: &v2.KubernetesTarget{Name: serverName},
				},
			},
		},
	}
	...
	s.Client.EXPECT().List(gomock.Any(), gomock.AssignableToTypeOf(&v2.ProtectedServiceList{}), gomock.Any(), gomock.Any()).DoAndReturn(
		func(ctx context.Context, protectedServices *v2.ProtectedServiceList, options ...client.ListOption) error {
			svc := v2.ProtectedService{
				ObjectMeta: v1.ObjectMeta{
					Name:      "protected-service",
					Namespace: clientIntentsNamespace,
				},
				Spec: v2.ProtectedServiceSpec{
					Name: serverName,
				},
			}
...
func (s *PolicyManagerTestSuite) TestDeleteAllPoliciesForClientIntents() {
	...
	intents := &v2.ClientIntents{
		...
		Spec: &v2.IntentsSpec{
			...
			Targets: []v2.Target{
				{
					Kubernetes: &v2.KubernetesTarget{Name: serverName1},
				},
				{
					Kubernetes: &v2.KubernetesTarget{Name: serverName2},
				},
			},
		},
	}
	...
	s.Client.EXPECT().List(gomock.Any(), gomock.Any(), client.MatchingLabels{
		v2.OtterizeIstioClientAnnotationKeyDeprecated: "test-client-test-namespace-537e87",
	})
	s.Client.EXPECT().List(gomock.Any(), gomock.Any(), client.MatchingLabels{
		v2.OtterizeIstioClientWithKindLabelKey: "test-client-test-namespace-537e87",
...
func (s *PolicyManagerTestSuite) TestDeletePolicy() {
	...
	outdatedPolicy := &v1beta1.AuthorizationPolicy{
		ObjectMeta: v1.ObjectMeta{
			...
			Namespace: clientIntentsNamespace,
			Labels: map[string]string{
				v2.OtterizeServiceLabelKey:             "test-server-from-old-intent-file",
				v2.OtterizeIstioClientWithKindLabelKey: "test-client-test-namespace-537e87",
			},
			UID: "uid_2",
		},
...
func (s *PolicyManagerTestSuite) TestUpdateStatusServiceAccount() {
	...
	clientServiceAccountName := "test-client-sa"
	labeledIntents := v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
			Name:      "test-client-intents",
			Namespace: clientIntentsNamespace,
			Annotations: map[string]string{
				v2.OtterizeClientServiceAccountAnnotation: clientServiceAccountName,
			},
		},
		Spec: &v2.IntentsSpec{
			Workload: v2.Workload{
	...
	intentsWithStatus := v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
			Name:      "test-client-intents",
			Namespace: clientIntentsNamespace,
			Annotations: map[string]string{
	...
	gomock.InOrder(
		s.Client.EXPECT().Patch(gomock.Any(), gomock.Any(), gomock.Any()).Do(func(_ context.Context, intents *v2.ClientIntents, _ client.Patch, _ ...client.PatchOption) {
			s.Equal(labeledIntents, *intents)
		}).Return(nil),
		s.Client.EXPECT().Patch(gomock.Any(), gomock.Any(), gomock.Any()).Do(func(_ context.Context, intents *v2.ClientIntents, _ client.Patch, _ ...client.PatchOption) {
			missingSideCar, ok := intents.Annotations[v2.OtterizeMissingSidecarAnnotation]
			s.True(ok)
			s.Equal(strconv.FormatBool(false), missingSideCar)
		}).Return(nil),
		s.Client.EXPECT().List(gomock.Any(), &v2.ClientIntentsList{}, &client.ListOptions{Namespace: clientIntentsNamespace}).Do(func(_ context.Context, intents *v2.ClientIntentsList, _ ...client.ListOption) {
...
func (s *PolicyManagerTestSuite) TestUpdateStatusServerMissingSidecar() {
	...
	intentsWithStatus.Annotations = map[string]string{
		v2.OtterizeServersWithoutSidecarAnnotation: string(lo.Must(json.Marshal([]string{serverName}))),
	}
...
func emptyIntents(clientIntentsNamespace string, clientName string, serverName string) *v2.ClientIntents {
	intents := &v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
			Name:      "test-client-intents",
			Namespace: clientIntentsNamespace,
...
func (s *PolicyManagerTestSuite) TestUpdateStatusServerMissingSidecarExistingServers() {
	...
	initialIntents := emptyIntents(clientIntentsNamespace, clientName, serverName)
	initialIntents.Annotations = map[string]string{
		v2.OtterizeServersWithoutSidecarAnnotation: initialServersList,
	}

	expectedServersList := string(lo.Must(json.Marshal([]string{"a-server", serverName, "x-server"})))
	intentsWithStatus := initialIntents.DeepCopy()
	intentsWithStatus.Annotations = map[string]string{
		v2.OtterizeServersWithoutSidecarAnnotation: expectedServersList,
	}
...
func (s *PolicyManagerTestSuite) TestUpdateStatusServerHasSidecarRemovedLastFromList() {
	...
	initialIntents := emptyIntents(clientIntentsNamespace, clientName, serverName)
	initialIntents.Annotations = map[string]string{
		v2.OtterizeServersWithoutSidecarAnnotation: initialServerList,
	}
...
func (s *PolicyManagerTestSuite) TestUpdateStatusSharedServiceAccount() {
	...
	anotherIntents := v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
		...
		Spec: &v2.IntentsSpec{
			...
			Targets: []v2.Target{
				{
					Kubernetes: &v2.KubernetesTarget{Name: "another-server"},
				},
			},
		},
	}
	...
	intentsWithStatus := v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
			...
			Annotations: map[string]string{
				v2.OtterizeClientServiceAccountAnnotation: clientServiceAccountName,
				v2.OtterizeSharedServiceAccountAnnotation: "true",
			},
		},
		Spec: &v2.IntentsSpec{
			Workload: v2.Workload{
	...
	anotherIntentsWithStatus := v2.ClientIntents{
		ObjectMeta: v1.ObjectMeta{
			Name:      "test-other-client-intents",
			Namespace: clientIntentsNamespace,
			Annotations: map[string]string{
