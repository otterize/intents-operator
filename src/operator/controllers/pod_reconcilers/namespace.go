...
func (ns *NamespaceWatcher) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	updatedNS.Labels[otterizev2.KubernetesStandardNamespaceNameLabelKey] = req.Name
...
func (ns *NamespaceWatcher) hasKubernetesNameLabel(namespace *v1.Namespace) bool {
	_, exists := namespace.Labels[otterizev2.KubernetesStandardNamespaceNameLabelKey]
	return exists
}
