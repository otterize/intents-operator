...
func (m *MockPolicyManager) Create(ctx context.Context, clientIntents *v2alpha1.ApprovedClientIntents, clientServiceAccount string) error {
	m.ctrl.T.Helper()
...
func (m *MockPolicyManager) DeleteAll(ctx context.Context, clientIntents *v2alpha1.ApprovedClientIntents) error {
	m.ctrl.T.Helper()
...
func (m *MockPolicyManager) RemoveDeprecatedPoliciesForClient(ctx context.Context, clientIntents *v2alpha1.ApprovedClientIntents) error {
	m.ctrl.T.Helper()
...
func (m *MockPolicyManager) UpdateIntentsStatus(ctx context.Context, clientIntents *v2alpha1.ApprovedClientIntents, clientServiceAccount string, missingSideCar bool) error {
	m.ctrl.T.Helper()
...
func (m *MockPolicyManager) UpdateServerSidecar(ctx context.Context, clientIntents *v2alpha1.ApprovedClientIntents, serverName string, missingSideCar bool) error {
	m.ctrl.T.Helper()
