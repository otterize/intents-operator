...
//go:generate go run go.uber.org/mock/mockgen@v0.2.0 -destination=./mocks/mock_external_netpol_handler.go -package=intentsreconcilersmocks -source=./networkpolicy/reconciler.go externalNetpolHandler
