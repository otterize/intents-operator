...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -destination=./mocks/mock_istio_admin.go -package=intentsreconcilersmocks -source=../istiopolicy/admin.go Admin
