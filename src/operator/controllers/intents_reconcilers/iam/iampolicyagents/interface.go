...
type IAMPolicyAgent interface {
	...
	AddRolePolicyFromIntents(ctx context.Context, namespace string, accountName string, intentsServiceName string, intents otterizev2alpha1.ApprovedClientIntents, filteredTargets []otterizev2alpha1.Target, pod corev1.Pod) error
