...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -destination=./mocks/mock_intents_admin.go -package=kafkaaclsmocks -source=intents_admin.go ClusterAdmin
