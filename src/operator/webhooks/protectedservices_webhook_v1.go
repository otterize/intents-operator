...
type ProtectedServiceValidatorV1 struct {
	client.Client
}
...
func NewProtectedServiceValidatorV1(c client.Client) *ProtectedServiceValidatorV1 {
	return &ProtectedServiceValidatorV1{
		Client: c,
	}
}

//+kubebuilder:webhook:matchPolicy=Exact,path=/validate-k8s-otterize-com-v1-protectedservice,mutating=false,failurePolicy=fail,sideEffects=None,groups=k8s.otterize.com,resources=protectedservice,verbs=create;update,versions=v1,name=protectedservicev1.kb.io,admissionReviewVersions=v1
...
func (v *ProtectedServiceValidatorV1) ValidateDelete(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	return nil, nil
}
