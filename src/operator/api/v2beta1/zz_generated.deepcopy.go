...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientIntentsStatus) DeepCopyInto(out *ClientIntentsStatus) {
	*out = *in
	if in.ResolvedIPs != nil {
		in, out := &in.ResolvedIPs, &out.ResolvedIPs
		*out = make([]ResolvedIPs, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientIntentsStatus.
func (in *ClientIntentsStatus) DeepCopy() *ClientIntentsStatus {
	if in == nil {
		return nil
	}
	out := new(ClientIntentsStatus)
	in.DeepCopyInto(out)
	return out
}
