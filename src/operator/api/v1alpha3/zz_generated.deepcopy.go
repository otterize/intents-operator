...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (ksc *KafkaServerConfig) DeepCopyInto(out *KafkaServerConfig) {
	*out = *ksc
	out.TypeMeta = ksc.TypeMeta
	ksc.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	ksc.Spec.DeepCopyInto(&out.Spec)
	out.Status = ksc.Status
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaServerConfig.
func (ksc *KafkaServerConfig) DeepCopy() *KafkaServerConfig {
	if ksc == nil {
		return nil
	}
	out := new(KafkaServerConfig)
	ksc.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (ksc *KafkaServerConfig) DeepCopyObject() runtime.Object {
	if c := ksc.DeepCopy(); c != nil {
		return c
	}
	return nil
}
