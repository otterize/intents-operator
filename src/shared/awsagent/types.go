...
const markAsUnusedInsteadOfDeleteTagKey = "otterize/markAsUnusedInsteadOfDelete"
const markAsUnusedInsteadOfDeleteValue = "true"
const unusedTagKey = "otterize/unused"
const unusedTagValue = "true"
