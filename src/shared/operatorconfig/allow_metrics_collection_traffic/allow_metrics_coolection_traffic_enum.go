package allow_metrics_collection_traffic
...
func (e *Enum) Set(value string) error {
	...
	return errors.Errorf("invalid value %s for allowMetricsCollectionTraffic", value)
}

func (e *Enum) Type() string {
	return "allowMetricsCollectionTraffic.Enum"
}
