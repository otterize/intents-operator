...
func (s *AzureAgentPoliciesSuite) expectGetUserAssignedIdentityReturnsClientID(clientId string) {
...
func (s *AzureAgentPoliciesSuite) expectListRoleAssignmentsReturnsEmpty() {
...
func (s *AzureAgentPoliciesSuite) expectListKeyVaultsReturnsNames(names ...string) {
...
func (s *AzureAgentPoliciesSuite) expectGetKeyVaultReturnsAccessPolicies(keyVaultName string, policies []*armkeyvault.AccessPolicyEntry) {
...
func (s *AzureAgentPoliciesSuite) expectUpdateKeyVaultAccessPolicyWritesPolicy(keyVaultName string, updateKind armkeyvault.AccessPolicyUpdateKind, updatedPolicy *armkeyvault.VaultAccessPolicyParameters) {
