...
type ServiceResolver interface {
	ResolveClientIntentToPod(ctx context.Context, intent v2.ClientIntents) (corev1.Pod, error)
...
func (r *Resolver) ResolveServiceIdentityToPodSlice(ctx context.Context, identity serviceidentity.ServiceIdentity) ([]corev1.Pod, bool, error) {
	labels, ok, err := v2.ServiceIdentityToLabelsForWorkloadSelection(ctx, r.client, identity)
	if err != nil {
...
func (r *Resolver) ResolveClientIntentToPod(ctx context.Context, intent v2.ClientIntents) (corev1.Pod, error) {
