...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -destination=mocks/spireclient/mock.go github.com/otterize/spifferize/src/spireclient ServerClient
...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -destination=mocks/spireclient/entries/mock.go github.com/otterize/spifferize/src/spireclient/entries Registry
...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -destination=mocks/secrets/mock.go github.com/otterize/spifferize/src/operator/secrets Manager
